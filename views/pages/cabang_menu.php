                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label><h4 class="card-title"></h4></label><a href="<?php echo base_url(); ?>parameter/tambah_cabang" class="btn btn-danger" role="button">Tambah Cabang Baru</a>
                                <hr>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="<?php echo site_url('parameter/cabang_delete/' . $kodecabang); ?>" class="btn btn-secondary btn-sm" role="button">Delete</a>
                                                                </div>
                                                            </div><!-- /.modal-content -->
                                                        </div><!-- /.modal-dialog -->
                                                    </div><!-- /.modal -->
                                                <a href="<?php echo site_url('parameter/cabang_edit/' . $kodecabang); ?>" class="btn btn-warning btn-sm" role="button">Edit</a></td>
                                                </tr>
                                            <?php
                                                }
                                            }
