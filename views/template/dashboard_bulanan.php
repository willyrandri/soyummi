                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="ml-2 align-self-center">
                                        ...
                                        if ($biaya < 1){
                                            ?>
                                            <h5 class="text-muted mb-0">Biaya <span class="green-text"><b>0</b></span></h5>
                                            <?php
                                        }
                                        else {
                                            ?>
                                            <h5 class="text-muted mb-0">Biaya <span class="green-text"><b><?php echo number_format($biaya); ?></b></span></h5>
                                            <?php
                                        }
                                        ?>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="ml-2 align-self-center">
                                        <h4 class="mb-0 font-weight-light">
                                        <?php 
                                        $nett = $nom_penjualan - $biaya;
                                        if ($nett === NULL){
                                            ?>
                                            <h5 class="text-muted mb-0">Nett <span class="green-text"><b>0</b></span></h5>
                                            <?php
                                        }
                                        else {
                                            ?>
                                            <h5 class="text-muted mb-0">Nett <span class="green-text"><b><?php echo number_format($nett); ?></b></span></h5>
                                            <?php
                                        }
                                        ?>
                                    </div>
